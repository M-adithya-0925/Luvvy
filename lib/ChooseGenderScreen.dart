    ...
    if (selectedGender != null && !_isNavigating) {
      ...
      if (mounted) {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => const RelationshipGoalsScreen(), // Add args if needed
          ),
        );
            ...
            children: [
              ...
              Expanded(
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      _buildGenderOption("Man", isSelected: selectedGender == "Man"),
                      _buildGenderOption("Woman", isSelected: selectedGender == "Woman"),
                      _buildMoreOption(),
                      if (_showMoreOptions) ...[
                        const SizedBox(height: 8),
                        ...moreGenderOptions.map(
                          (option) => _buildGenderOption(
                            option,
